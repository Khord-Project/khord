<!-- Canonical version: docs/README.md — update there first -->
...
Both servers expose their OpenAPI schema and interactive docs by default — useful for third-party client development and for inspecting the wire protocol without reading source.

| Server | Swagger UI | ReDoc | OpenAPI JSON |
|---|---|---|---|
| Key Server (`keys.khord.org`) | [/docs](https://keys.khord.org/docs) | [/redoc](https://keys.khord.org/redoc) | [/openapi.json](https://keys.khord.org/openapi.json) |
| Relay Server (`relay.khord.org`) | [/docs](https://relay.khord.org/docs) | [/redoc](https://relay.khord.org/redoc) | [/openapi.json](https://relay.khord.org/openapi.json) |

Self-hosted instances expose the same paths against whatever host you've deployed to. Generated by FastAPI at startup — no separate spec to keep in sync.
