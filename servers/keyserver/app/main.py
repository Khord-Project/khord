...
# the blanket per-IP ceiling to every route; stricter per-route limits are
# stacked as decorators in the routers. The handler turns a tripped limit into
# a 429. State lives on app.state so slowapi can find it.
